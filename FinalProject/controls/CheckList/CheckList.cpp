...
CheckList::CheckList(short left, short top, short width, BorderDrawer *border, Color textColor, Color backgroundColor) : Control(left, top, width, 0, border, textColor, backgroundColor)
{
    focusIndex = -1;
}
...
{
    CheckBox *newItem = new CheckBox(0, (items.size() * 3), getWidth() - 3, border, textColor, backgroundColor, item);
